...
Save the voice and tone guide to `.jimmy/docs/ux-writing-voice-and-tone.md`.
...
Save to `.jimmy/docs/ux-writing-voice-and-tone.md`
...
writing PRD copy. Append to `.jimmy/decisions.md`.

**Microcopy set (BUILD or ARCHITECT):**
Save to `.jimmy/work/<YYYYMMDD>-<slug>/microcopy.md`
Organized by screen/flow, with all touchpoints covered.

**Content audit (ARCHITECT):**
Save to `.jimmy/docs/content-audit.md`
...
## Applied context (edtech — not part of the original)
> Blocks: unmeasurable "impressive" copy reaching the UI. Benchmark: "'deeply integrated curriculum' — how deep? integrated how? A competitor says: 54 study hours, method ABC, free books — instantly clear." Adjectives become numbers or get cut. Error messages follow the 3-step pattern and must cover the AI-grading-failure branch (never lose the submission; retry silently).
