...
├── CONTEXT-MAP.md
├── .jimmy/
│   └── adr/                          ← system-wide decisions (0001-slug.md …)
...
Create files lazily — only when you have something to write. If no `CONTEXT.md` exists, create one when the first term is resolved. If no `.jimmy/adr/` exists, create it when the first ADR is needed.
